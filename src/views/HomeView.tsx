...
export const HomeView: React.FC<HomeViewProps> = ({ onSelectTab }) => {
  ...
  return (
    <div className="relative bg-[#F4F8FC] text-[#102547]">
      ...
      <section className="py-16 md:py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-[#F4F8FC] to-[#EAF2FA] border border-sky-900/10 p-8 sm:p-10 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group">
              <div>
            ...
            <div className="rounded-3xl bg-gradient-to-br from-[#EAF2FA] to-[#F4F8FC] border border-sky-900/10 p-8 sm:p-10 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group">
              <div>
                <div className="w-12 h-12 rounded-2xl bg-[#0284C7] text-white flex items-center justify-center mb-6 shadow-md group-hover:scale-105 transition-transform">
              ...
              <button
                onClick={() => onSelectTab('servicios-tributarios')}
                className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-6 rounded-2xl text-xs sm:text-sm font-bold bg-[#0284C7] hover:bg-[#0369a1] text-white transition-all cursor-pointer shadow-md shadow-sky-500/20"
              >
      ...
      {/* ========================================================= */}
      <section className="py-16 md:py-24 bg-[#F4F8FC] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 py-3 px-5 rounded-xl text-xs sm:text-sm font-semibold text-[#102547] bg-white border border-sky-200 hover:bg-slate-50 transition-all cursor-pointer"
                >
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="p-8 rounded-3xl bg-white border border-sky-900/10 shadow-lg text-center max-w-sm w-full">
                ...
                <div className="space-y-2.5 text-xs text-left mb-6">
                  <div className="p-3 rounded-xl bg-[#F4F8FC] border border-sky-100 flex items-center justify-between">
                    <span className="font-bold text-[#102547]">Columna 1: Contable</span>
                    <span className="text-[#0284C7] font-semibold">8 Soluciones</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#F4F8FC] border border-sky-100 flex items-center justify-between">
                  ...
                  <div className="p-3 rounded-xl bg-[#F4F8FC] border border-sky-100 flex items-center justify-between">
                    ...
                    <span className="text-[#0284C7] font-semibold">5 Soluciones</span>
                  </div>
                </div>
